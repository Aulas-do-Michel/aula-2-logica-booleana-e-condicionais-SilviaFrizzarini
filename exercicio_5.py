...
frequencia = float(input("Digite a frequencia populacional (em porcentagem): "))
...
frequencia_alta = frequencia > 5

if artefato:
    print("Não é relevante.")
elif impacto_baixo or (frequencia_alta and not excecao):
    print("Não é relevante.")
else:
    print("É relevante.")
